...
HD_PWD='E:/FPGA/nowone/SnakeGame/SnakeGame.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log direction_judgement_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source direction_judgement_top.tcl -notrace
