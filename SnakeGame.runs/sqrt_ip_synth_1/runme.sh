...
HD_PWD='E:/FPGA/SnakeGame/SnakeGame/SnakeGame.runs/sqrt_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sqrt_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sqrt_ip.tcl
