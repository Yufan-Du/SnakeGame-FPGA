...
HD_PWD='E:/FPGA/nowone/SnakeGame/SnakeGame.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log direction_judgement_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source direction_judgement_top.tcl
