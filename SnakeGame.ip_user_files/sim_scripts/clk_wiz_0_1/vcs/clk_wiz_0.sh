...
#
# Generated by Vivado on Tue May 23 08:28:09 +0800 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../SnakeGame.gen/sources_1/ip/clk_wiz_0_1/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../SnakeGame.gen/sources_1/ip/clk_wiz_0_1/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
